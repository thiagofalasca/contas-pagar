...
public class UsuarioDTO {
    ...
    @NotBlank(groups = {OnCreate.class}, message = "O nome não pode ser vazio")
    ...
    @NotBlank(groups = {OnCreate.class}, message = "O e-mail não pode ser vazio")
    ...
    @NotBlank(groups = {OnCreate.class}, message = "A senha não pode ser vazia")
